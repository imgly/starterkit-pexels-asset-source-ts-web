...
Build a design editor with integrated [Pexels](https://www.pexels.com/) stock photos — search and browse millions of free, high-quality images directly within your editor. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies.

<p>
  <a href="https://img.ly/docs/cesdk/starterkits/pexels-image-editor/">Documentation</a> |
...
```bash
git clone https://github.com/imgly/starterkit-pexels-image-editor-ts-web.git
cd starterkit-pexels-image-editor-ts-web
```
...
```
starterkit-pexels-image-editor-ts-web/
├── src/
│   ├── index.ts              # Application entry point
│   └── imgly/
│       ├── index.ts          # Editor initialization
│       ├── config/           # DesignEditorConfig plugin (symlink)
│       └── asset-sources/
│           └── pexels/
│               ├── index.ts  # Pexels asset source setup
│               └── api.ts    # Pexels API wrapper
